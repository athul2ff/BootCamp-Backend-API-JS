...
exports.forgotPassword = asyncHandler(async (req, res, next) => {
  ...
  console.log("getResetPasswordToken", user.getResetPasswordToken());
  // Get reset token
  ...
  const message = `You are receiving this email because you (or someone else) has requested the reset the password of a password Please make a PUT request to: \n\n ${resetUrl}`;
